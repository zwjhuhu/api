 ...
 * @since  2019.7.27
 */
public class CreateAndStartVMFromImageTest  {

	public static void main(String[] args) throws Exception {
		ExtendedKubernetesClient client = getClient();
		CreateVMFromImageBean bean = get();
		client.virtualMachines().createAndStartVMFromImage(bean.getName(), "node30",
				BeanConvertorUtils.toCreateAndStartVMFromImage(bean));
	}
	
	public static CreateVMFromImageBean get() {
		CreateVMFromImageBean image = new CreateVMFromImageBean();
		image.setName("750646e8c17a49d0b83c1c797811e078");
		...
		image.setTemplate("/var/lib/libvirt/template/bbb.qcow2");
		...
		RootCloudDiskSpecificationFromTemplate sysdisk = new RootCloudDiskSpecificationFromTemplate();
		sysdisk.setReadingSpeed(20480000L);
		sysdisk.setWriteSpeed(20480000L);
		image.setRootCloudDiskSpecificationFromTemplate(sysdisk);
